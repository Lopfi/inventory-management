    ...
    <div>
        <div class="results" id="results" v-if="results">
            ...
            <btn
                ...
                :url="`http://localhost:3000/api/locations/labels?limit=${this.limit}&offset=${this.offset}`"
            />
            <btn
                :method="this.method"
                :label="'Load more'"
...
export default {
    ...
    methods: {
        getResults() {
            axios
                .get(`http://localhost:3000/api/${this.kind}?limit=${this.limit}&offset=${this.offset}`)
